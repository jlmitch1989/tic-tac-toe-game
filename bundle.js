...
/***/ function(module, exports, __webpack_require__) {
	...
	var toePic = 'assets/toe-pic.jpg';
	var ticTacPic = 'assets/tic-tac-pic.jpg';
	...
	//update
	var patchGame = function patchGame(i, v, b) {
	  // console.log('patch game function');
	  api.updateGame(i, v, b).done(ui.patchGameSuccess).fail(ui.failure);
	};
	// GET games
	...
	var getWinner = function getWinner() {
	  ...
	  gameBoardArray[1] === 'x' && gameBoardArray[2] === 'x') {
	    return 'x';
	  }
	  if (gameBoardArray[3] === 'x' && gameBoardArray[4] === 'x' && gameBoardArray[5] === 'x') {
	    return 'x';
	  }
	  ...
	  gameBoardArray[3] === 'x' && gameBoardArray[6] === 'x') {
	    return 'x';
	  }
	  ...
	  gameBoardArray[4] === 'x' && gameBoardArray[8] === 'x') {
	    return 'x';
	  }
	  if (gameBoardArray[2] === 'x' && gameBoardArray[4] === 'x' && gameBoardArray[6] === 'x') {
	    return 'x';
	  }
	  if (gameBoardArray[0] === 'o' && //Start of rows for 'o'
	  gameBoardArray[1] === 'o' && gameBoardArray[2] === 'o') {
	    return 'o';
	  }
	  if (gameBoardArray[3] === 'o' && gameBoardArray[4] === 'o' && gameBoardArray[5] === 'o') {
	    return 'o';
	  }
	  ...
	  gameBoardArray[3] === 'o' && gameBoardArray[6] === 'o') {
	    return 'o';
	  }
	  ...
	  gameBoardArray[4] === 'o' && gameBoardArray[8] === 'o') {
	    return 'o';
	  }
	  if (gameBoardArray[2] === 'o' && gameBoardArray[4] === 'o' && gameBoardArray[6] === 'o') {
	    return 'o';
	  }
	};
	...
	var onTurn = function onTurn() {
	  ...
	  if ($tile.attr('style')) {
	    ...
	    if (counter % 2) {
	      ...
	      var index = parseInt($tile.data('index'), 10);
	      ...
	      var _index = parseInt($tile.data('index'), 10);
	      gameBoardArray[_index] = 'o';
	      patchGame(_index, 'o', endGame());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(i, v, b) {
	  return $.ajax({
